...
class Processor:
    ...
    def raise_gl_error_if_exists(self):
        gl_error = glGetError()
        if gl_error:
    ...
    def process(self, frame):
        ...
        # Draw textured quad with shader program
        try:
    ...
    def run(self):
        ...
        while not glfw.window_should_close(self.window) and not self.key_char_pressed('q'):
